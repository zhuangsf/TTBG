package com.android.ttbg.view.countdownview;
...
public class CountdownView extends View {
    ...
    public long getmViewCreateTime() {
		return mViewCreateTime;
	}

	public void setmViewCreateTime(long mViewCreateTime) {
		this.mViewCreateTime = mViewCreateTime;
	}
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCountdown.onMeasure1(this, viewWidth, viewHeight, contentAllWidth, contentAllHeight);
    }
